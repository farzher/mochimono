...
.image-optimize-divider{position:absolute;z-index:3;left:var(--split);top:0;bottom:0;width:40px;transform:translateX(-50%);background:transparent;cursor:e-resize;pointer-events:auto;touch-action:none}
.image-optimize-divider:before{content:'';position:absolute;left:50%;top:0;bottom:0;width:4px;transform:translateX(-50%);background:rgba(0,0,0,.62);box-shadow:0 0 0 1px rgba(255,255,255,.04);transition:background .12s ease}
.image-optimize-divider:after{content:'↔';position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);display:flex;align-items:center;justify-content:center;box-sizing:border-box;width:34px;height:34px;padding-bottom:1px;border-radius:50%;background:rgba(0,0,0,.72);border:1px solid rgba(255,255,255,.24);color:#fff;font-family:Arial,sans-serif;font-size:17px;font-weight:400;line-height:1;box-shadow:0 3px 14px rgba(0,0,0,.34);transition:background .12s ease,border-color .12s ease}
.image-optimize-divider:hover:before{background:rgba(0,0,0,.76)}.image-optimize-divider:hover:after{background:rgba(0,0,0,.82);border-color:rgba(255,255,255,.38)}
