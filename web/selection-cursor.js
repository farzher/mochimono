...
style.textContent = `
  ...
  html.keyboard-navigation-active #files.grid .file-card.keyboard-cursor{position:relative;z-index:2;outline:none!important}
  html.keyboard-navigation-active #files.grid .file-card.media-card.keyboard-cursor::before{opacity:0!important;transform:none!important;transition:none!important}
  html.keyboard-navigation-active #files.grid .file-card.media-card.keyboard-cursor::after{
  ...
  html.keyboard-navigation-active #files.grid .file-card:not(.media-card).keyboard-cursor{box-shadow:inset 0 0 0 4px #efa09a,inset 0 0 0 5px rgba(0,0,0,.82)!important}
  html.keyboard-navigation-active #files.grid .file-card.keyboard-cursor .file-context-badge{opacity:1!important;transform:none!important;transition:none!important}
