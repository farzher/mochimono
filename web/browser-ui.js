...
const similarOption = document.querySelector('#sort option[value="similar"]');
const visualOption = document.querySelector('#sort option[value="visual"]');
if (similarOption && visualOption) similarOption.after(visualOption);
