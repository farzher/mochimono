...
.experimental-view-viewport{position:absolute;inset:0;overflow:hidden;touch-action:none;outline:0;background:#0e0d0f;cursor:grab}.experimental-view-viewport.dragging{cursor:grabbing}.experimental-view-viewport.over-media:not(.dragging){cursor:pointer}.experimental-view-viewport.grid-mode{overflow:auto;touch-action:auto;cursor:default}
.experimental-view-canvas{position:absolute;inset:0;width:100%;height:100%;display:block;z-index:1;background:#0e0d0f}.experimental-view-canvas[hidden]{display:none}
