...
export class FriendSignalingClient {
  ...
  async raw(path, options = {}) {
    ...
    try {
      ...
      const configured = Boolean(process.env.MOCHIMONO_SIGNAL_URL);
      const hint = configured
        ? `Friend signaling is unreachable at ${this.base}`
        : `Friend signaling is unreachable at ${this.base}. Set MOCHIMONO_SIGNAL_URL to the public HTTPS signaling endpoint.`;
